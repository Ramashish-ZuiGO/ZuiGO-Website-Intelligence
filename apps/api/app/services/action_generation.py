...
FINDING_TO_ACTION_MAP: dict[str, dict[str, Any]] = {
    ...
    "TITLE_TOO_SHORT": {
        "issue_title": "Page title is too short",
        "category": "seo",
        "severity": "low",
        "grouping_key": "title_too_short",
        "estimated_effort": "low",
        "business_impact": "minor",
        "responsible_area": "CMS/content",
        "responsible_role": "Content editor",
        "action_location": "Page metadata",
        "why_this_matters": "Titles under roughly 30 characters under-use the space search engines allocate for the result snippet, giving users less context to decide whether to click through.",
        "exact_correction": "Expand the <title> element to a descriptive 30-60 character summary of the page's content, including primary keywords.",
        "implementation_steps": "1. Open the page template or CMS page editor.\n2. Locate the <title> element.\n3. Rewrite it to be 30-60 characters, describing the page's specific content rather than a generic label.",
        "verification_steps": "1. View the page HTML source.\n2. Confirm the title text length falls within 30-60 characters.",
        "expected_result": "The title fills a useful portion of the search-result snippet without being truncated.",
        "limitations": "This check only measures character count. Title relevance and keyword quality require manual review.",
        "score_impact": 3,
    },
    "TITLE_TOO_LONG": {
        "issue_title": "Page title is too long",
        "category": "seo",
        "severity": "low",
        "grouping_key": "title_too_long",
        "estimated_effort": "low",
        "business_impact": "minor",
        "responsible_area": "CMS/content",
        "responsible_role": "Content editor",
        "action_location": "Page metadata",
        "why_this_matters": "Titles over roughly 60 characters are commonly truncated in search results, which can cut off the most important words or make the snippet look unfinished.",
        "exact_correction": "Shorten the <title> element to 30-60 characters while keeping the most important, specific words at the front.",
        "implementation_steps": "1. Open the page template or CMS page editor.\n2. Locate the <title> element.\n3. Trim it to 30-60 characters, prioritizing the page's specific topic over boilerplate branding suffixes.",
        "verification_steps": "1. View the page HTML source.\n2. Confirm the title text length falls within 30-60 characters.",
        "expected_result": "The full title renders in search results without mid-word truncation.",
        "limitations": "This check only measures character count; actual truncation depends on the search engine's rendering, which varies by query and device.",
        "score_impact": 3,
    },
    "META_DESCRIPTION_TOO_SHORT": {
        "issue_title": "Meta description is too short",
        "category": "seo",
        "severity": "low",
        "grouping_key": "meta_description_too_short",
        "estimated_effort": "low",
        "business_impact": "minor",
        "responsible_area": "CMS/content",
        "responsible_role": "Content editor",
        "action_location": "Page metadata",
        "why_this_matters": "Meta descriptions under roughly 70 characters leave most of the search-result snippet blank or search-engine-generated, missing a chance to persuade users to click through.",
        "exact_correction": "Expand the meta description to a 70-160 character summary of the page's content and value to the reader.",
        "implementation_steps": '1. Open the page template or CMS SEO settings.\n2. Locate the <meta name="description"> element.\n3. Rewrite it to be 70-160 characters, summarizing the page and including a reason to click through.',
        "verification_steps": "1. View the page HTML source.\n2. Confirm the meta description length falls within 70-160 characters.",
        "expected_result": "Search results show a complete, persuasive snippet instead of a thin or search-engine-substituted one.",
        "limitations": "This check only measures character count. Search engines may still substitute their own snippet regardless of length.",
        "score_impact": 3,
    },
    "META_DESCRIPTION_TOO_LONG": {
        "issue_title": "Meta description is too long",
        "category": "seo",
        "severity": "low",
        "grouping_key": "meta_description_too_long",
        "estimated_effort": "low",
        "business_impact": "minor",
        "responsible_area": "CMS/content",
        "responsible_role": "Content editor",
        "action_location": "Page metadata",
        "why_this_matters": "Meta descriptions over roughly 160 characters are commonly truncated mid-sentence in search results, which can look unpolished and cut off the call to action.",
        "exact_correction": "Shorten the meta description to 70-160 characters, keeping the strongest reason to click near the start.",
        "implementation_steps": '1. Open the page template or CMS SEO settings.\n2. Locate the <meta name="description"> element.\n3. Trim it to 70-160 characters without losing the core value proposition.',
        "verification_steps": "1. View the page HTML source.\n2. Confirm the meta description length falls within 70-160 characters.",
        "expected_result": "The full meta description renders in search results without mid-sentence truncation.",
        "limitations": "This check only measures character count; actual truncation depends on the search engine's rendering, which varies by query and device.",
        "score_impact": 3,
    },
    "MISSING_OPEN_GRAPH_TAGS": {
        "issue_title": "Missing Open Graph tags",
        "category": "seo",
        "severity": "medium",
        "grouping_key": "missing_open_graph_tags",
        "estimated_effort": "low",
        "business_impact": "moderate",
        "responsible_area": "frontend",
        "responsible_role": "Developer",
        "action_location": "Page head template",
        "why_this_matters": "Open Graph tags (og:title, og:description, og:image) control how the page appears when shared on Facebook, LinkedIn, and most other platforms. Without them, shared links show a blank, generic, or broken preview, reducing click-through and trust.",
        "exact_correction": "Add og:title, og:description, and og:image meta tags to the page's HTML head.",
        "implementation_steps": '1. Open the shared page head template.\n2. Add <meta property="og:title" content="..." />, <meta property="og:description" content="..." />, and <meta property="og:image" content="..." /> populated per page.\n3. Use a real, representative image at least 1200x630px for og:image.',
        "verification_steps": "1. View the page HTML source and confirm all three core Open Graph tags are present with non-empty content.\n2. Use a social-platform link-preview debugger to confirm the preview renders correctly.",
        "expected_result": "Links to the page render a real title, description, and image preview when shared on social platforms.",
        "limitations": "This check confirms tag presence only. Image dimensions, aspect ratio, and content quality require manual review.",
        "score_impact": 6,
    },
    "MISSING_TWITTER_CARD": {
        "issue_title": "Missing Twitter Card tag",
        "category": "seo",
        "severity": "low",
        "grouping_key": "missing_twitter_card",
        "estimated_effort": "low",
        "business_impact": "minor",
        "responsible_area": "frontend",
        "responsible_role": "Developer",
        "action_location": "Page head template",
        "why_this_matters": "The twitter:card meta tag controls whether links shared on X/Twitter render a rich preview card. Without it, shared links fall back to a plain text link with no image or description.",
        "exact_correction": 'Add a twitter:card meta tag (typically content="summary_large_image") to the page\'s HTML head.',
        "implementation_steps": '1. Open the shared page head template.\n2. Add <meta name="twitter:card" content="summary_large_image" />.\n3. Existing Open Graph tags (og:title, og:description, og:image) are reused automatically by X/Twitter when present.',
        "verification_steps": "1. View the page HTML source and confirm the twitter:card meta tag is present.\n2. Use X/Twitter's card validator to confirm the preview renders correctly.",
        "expected_result": "Links to the page render a rich preview card when shared on X/Twitter.",
        "limitations": "This check confirms tag presence only. Whether the resulting card actually renders correctly depends on X/Twitter's own crawler and caching behavior.",
        "score_impact": 2,
    },
    "IMAGES_MISSING_ALT": {
