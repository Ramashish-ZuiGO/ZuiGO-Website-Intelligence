...
website_pages = Table(
    ...
    Column("page_analysis_level_2_at", DateTime(timezone=True)),
...
page_analysis_runs = Table(
    "page_analysis_runs",
    metadata,
    Column("id", Uuid, primary_key=True),
    Column("website_page_id", Uuid, nullable=False),
    Column("discovery_run_id", Uuid),
    Column("page_analysis_execution_id", Uuid, nullable=False),
    Column("analysis_level", Integer, nullable=False),
    Column("status", String(30), nullable=False),
    Column("failure_reason_code", String(100)),
    Column("failure_reason_text", String(500)),
    Column("analysis_started_at", DateTime(timezone=True)),
    Column("analysis_completed_at", DateTime(timezone=True)),
    Column("requested_url", String(2048)),
    Column("final_url", String(2048)),
    Column("canonical_url", String(2048)),
    ...
    Column("heading_structure", JSON, nullable=False),
    Column("robots_directives", JSON, nullable=False),
    Column("content_type", String(200)),
    Column("language", String(50)),
    Column("structured_data_present", Boolean),
    Column("internal_link_count", Integer),
    Column("external_link_count", Integer),
    Column("image_count", Integer),
    Column("images_missing_alt", Integer),
    Column("form_count", Integer),
    Column("basic_accessibility_signals", JSON, nullable=False),
    Column("basic_seo_signals", JSON, nullable=False),
    Column("security_observations", JSON, nullable=False),
